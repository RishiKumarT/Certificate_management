...
export default function UpdateStudentProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put("http://localhost:1235/studentapi/updateprofile", payload)
        ...
        {student && (
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input type="text" value={student.id} disabled style={{ opacity: 0.6, cursor: 'not-allowed' }} />
            </div>

            <div className="form-group">
              <label>Gmail Address</label>
              <input type="email" value={student.email} disabled style={{ opacity: 0.6, cursor: 'not-allowed' }} />
            </div>

            <div className="form-group">
              <label>Gender / Department</label>
              <input type="text" value={`${student.gender} - ${student.department}`} disabled style={{ opacity: 0.6, cursor: 'not-allowed' }} />
            </div>
